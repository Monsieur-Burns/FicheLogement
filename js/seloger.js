...
$('textarea#motCleRecherche').blur(function(){
  ...
  if(varMotClef.test(elt.val()) && elt.val().trim().split(" ").length <= 4 ){
    console.log("if ok");
    console.log(elt.val().trim().split(" ").length);
...
// .trim() -> permet de suppreuimer les espace sde départ et de fin
/*
...
*/
$('input[class="typeLoc"]').click(function(){
